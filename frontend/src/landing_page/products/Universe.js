       ...
       <div className="container p-5">
            <div className="row justify-content-evenly align-items-center "style={{paddingLeft:"8%",paddingRight:"8%"}}>
                ...
                <div className='col-md-4 col-xs-10  text-center mb-5 p-2'>
                    <img src="media/zerodhaFundhouse.png" className='d-block mx-auto mb-3' alt=" " style={{width:"65%"}}></img>
                ...
                <div className='col-md-4 col-xs-10  text-center mb-5 p-2'>
                    <img src="media/sensibullLogo.svg" alt="" style={{width:"75%"}} className='d-block mx-auto mb-4'></img>
                ...
                <div className='col-md-4 col-xs-10  text-center mb-5 p-2'>
                    <img src="media/tijori.svg" alt="" style={{width:"50%"}} className='d-block mx-auto mb-3'></img>
                ...
                <div className='col-md-4 col-xs-10  text-center p-2'>
                    <img src="media/streakLogo.png" alt="" style={{width:"50%"}} className='d-block mx-auto mb-3'></img>
                ...
                <div className='col-md-4 col-xs-10  text-center p-2'>
                    <img src="media/smallcaseLogo.png" alt="" className='d-block mx-auto mb-3'></img>
                ...
                <div className='col-md-4 col-xs-10  text-center p-2'>
                    <img src="media/dittoLogo.png" alt="" style={{width:"40%"}} className='d-block mx-auto mb-3'></img>
