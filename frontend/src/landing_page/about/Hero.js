    ...
    return ( 
      <div className='container pt-5 px-5'>
        <div className='row p-5 border-bottom'>
            <h1 className='fs-4 text-center p-5' style={{color:"#424242", lineHeight:"1.5", fontSize:"1.5rem"}}>
                We pioneered the discount broking model in India. 
                <br/>
                Now, we are breaking ground with our technology.
            </h1>
        </div>
        <div className='row fs-6 mt-5' style={{color:"#424242",lineHeight:"1.8",fontWeight:"400", paddingLeft:"10%",paddingRight:"10%"}}>
